...
class SecondWardia extends StatefulWidget {
  const SecondWardia({Key? key}) : super(key: key);

  @override
  State<SecondWardia> createState() => _SecondWardiaState();
}

class _SecondWardiaState extends State<SecondWardia> {
  @override
  ...
  _AppointmentDataSource _getCalendarDataSource() {
    ...
    //النهار
    appointments.add(Appointment(
        startTime: DateTime(2022, 3, 30),
        // endTime: DateTime.now().add(Duration(hours: 1)),
        endTime: DateTime(2022, 3, 30),
        subject: 'النهار  ',
        color: Colors.blue,
        recurrenceRule: 'FREQ=DAILY;INTERVAL=24;COUNT=12'));
    appointments.add(Appointment(
