...
import 'package:flutter_auth/Screens/categories/dentals/add_task_screen.dart';
import 'package:flutter_auth/components/advalue.dart';
import 'package:intl/intl.dart';

class NewToDo extends StatelessWidget {
  NewToDo({this.dentalName});
  final String? dentalName;
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => Padding(
                    ...
                    child: AddTaskScreen(dentalName: dentalName),
                  ));
            }),
        appBar: AppBar(
          backgroundColor: Colors.purple,
            ...
            child: StreamBuilder(
              builder: (BuildContext context, AsyncSnapshot snapshot) {
               ...
               stream: FirebaseFirestore.instance
                  ...
                  .where('name', isEqualTo: '$dentalName')
