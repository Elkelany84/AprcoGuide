...
import 'package:flutter_auth/Screens/categories/glasses/add_task_screen.dart';
import 'package:intl/intl.dart';

class NewToDo extends StatelessWidget {
  NewToDo({this.glassName});
            ...
            onPressed: () {
              showModalBottomSheet(
                  ...
                  builder: (context) => Padding(
                    ...
                    child: AddTaskScreen(glassName: glassName),
                  ));
            }),
        appBar: AppBar(
          backgroundColor: Colors.purple,
            ...
            child: StreamBuilder(
              builder: (BuildContext context, AsyncSnapshot snapshot) {
               ...
               stream: FirebaseFirestore.instance
                  .collection('glassreviews')
                  .where('name', isEqualTo: '$glassName')
